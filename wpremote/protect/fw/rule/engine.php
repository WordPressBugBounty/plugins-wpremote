...
if (!class_exists('WPRProtectFWRuleEngine_V644')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V644 {
	use WPRProtectFWRuleStringFunc_V644;
	use WPRProtectFWRuleArrayFunc_V644;
	use WPRProtectFWRuleMiscFunc_V644;
	use WPRProtectFWRuleRequestFunc_V644;
	use WPRProtectFWRuleWPFunc_V644;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V644::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V644 $e) {
			$this->error = $e;
		}
	}
