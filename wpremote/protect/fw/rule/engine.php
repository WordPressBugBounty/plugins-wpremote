...
if (!class_exists('WPRProtectFWRuleEngine_V669')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V669 {
	use WPRProtectFWRuleStringFunc_V669;
	use WPRProtectFWRuleArrayFunc_V669;
	use WPRProtectFWRuleMiscFunc_V669;
	use WPRProtectFWRuleRequestFunc_V669;
	use WPRProtectFWRuleWPFunc_V669;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V669::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V669 $e) {
			$this->error = $e;
		}
	}
