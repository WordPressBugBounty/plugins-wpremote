...
if (!class_exists('WPRProtectFWRuleEngine_V591')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V591 {
	use WPRProtectFWRuleStringFunc_V591;
	use WPRProtectFWRuleArrayFunc_V591;
	use WPRProtectFWRuleMiscFunc_V591;
	use WPRProtectFWRuleRequestFunc_V591;
	use WPRProtectFWRuleWPFunc_V591;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V591::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V591 $e) {
			$this->error = $e;
		}
	}
