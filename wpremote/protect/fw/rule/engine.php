...
if (!class_exists('WPRProtectFWRuleEngine_V662')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V662 {
	use WPRProtectFWRuleStringFunc_V662;
	use WPRProtectFWRuleArrayFunc_V662;
	use WPRProtectFWRuleMiscFunc_V662;
	use WPRProtectFWRuleRequestFunc_V662;
	use WPRProtectFWRuleWPFunc_V662;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V662::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V662 $e) {
			$this->error = $e;
		}
	}
