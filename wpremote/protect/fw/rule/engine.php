...
if (!class_exists('WPRProtectFWRuleEngine_V639')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V639 {
	use WPRProtectFWRuleStringFunc_V639;
	use WPRProtectFWRuleArrayFunc_V639;
	use WPRProtectFWRuleMiscFunc_V639;
	use WPRProtectFWRuleRequestFunc_V639;
	use WPRProtectFWRuleWPFunc_V639;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V639::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V639 $e) {
			$this->error = $e;
		}
	}
