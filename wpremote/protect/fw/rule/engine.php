...
if (!class_exists('WPRProtectFWRuleEngine_V577')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V577 {
	use WPRProtectFWRuleStringFunc_V577;
	use WPRProtectFWRuleArrayFunc_V577;
	use WPRProtectFWRuleMiscFunc_V577;
	use WPRProtectFWRuleRequestFunc_V577;
	use WPRProtectFWRuleWPFunc_V577;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V577::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V577 $e) {
			$this->error = $e;
		}
	}
