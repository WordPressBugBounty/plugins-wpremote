...
if (!class_exists('WPRProtectFWRuleEngine_V636')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V636 {
	use WPRProtectFWRuleStringFunc_V636;
	use WPRProtectFWRuleArrayFunc_V636;
	use WPRProtectFWRuleMiscFunc_V636;
	use WPRProtectFWRuleRequestFunc_V636;
	use WPRProtectFWRuleWPFunc_V636;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V636::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V636 $e) {
			$this->error = $e;
		}
	}
