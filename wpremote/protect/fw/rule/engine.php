...
if (!class_exists('WPRProtectFWRuleEngine_V665')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V665 {
	use WPRProtectFWRuleStringFunc_V665;
	use WPRProtectFWRuleArrayFunc_V665;
	use WPRProtectFWRuleMiscFunc_V665;
	use WPRProtectFWRuleRequestFunc_V665;
	use WPRProtectFWRuleWPFunc_V665;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V665::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V665 $e) {
			$this->error = $e;
		}
	}
