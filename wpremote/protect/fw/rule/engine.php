...
if (!class_exists('WPRProtectFWRuleEngine_V647')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V647 {
	use WPRProtectFWRuleStringFunc_V647;
	use WPRProtectFWRuleArrayFunc_V647;
	use WPRProtectFWRuleMiscFunc_V647;
	use WPRProtectFWRuleRequestFunc_V647;
	use WPRProtectFWRuleWPFunc_V647;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V647::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V647 $e) {
			$this->error = $e;
		}
	}
