...
if (!class_exists('WPRProtectFWRuleEngine_V593')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V593 {
	use WPRProtectFWRuleStringFunc_V593;
	use WPRProtectFWRuleArrayFunc_V593;
	use WPRProtectFWRuleMiscFunc_V593;
	use WPRProtectFWRuleRequestFunc_V593;
	use WPRProtectFWRuleWPFunc_V593;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V593::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V593 $e) {
			$this->error = $e;
		}
	}
