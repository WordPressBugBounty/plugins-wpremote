...
if (!class_exists('WPRProtectFWRuleEngine_V592')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V592 {
	use WPRProtectFWRuleStringFunc_V592;
	use WPRProtectFWRuleArrayFunc_V592;
	use WPRProtectFWRuleMiscFunc_V592;
	use WPRProtectFWRuleRequestFunc_V592;
	use WPRProtectFWRuleWPFunc_V592;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V592::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V592 $e) {
			$this->error = $e;
		}
	}
