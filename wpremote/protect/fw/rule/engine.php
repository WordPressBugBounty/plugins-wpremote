...
if (!class_exists('WPRProtectFWRuleEngine_V648')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V648 {
	use WPRProtectFWRuleStringFunc_V648;
	use WPRProtectFWRuleArrayFunc_V648;
	use WPRProtectFWRuleMiscFunc_V648;
	use WPRProtectFWRuleRequestFunc_V648;
	use WPRProtectFWRuleWPFunc_V648;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V648::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V648 $e) {
			$this->error = $e;
		}
	}
