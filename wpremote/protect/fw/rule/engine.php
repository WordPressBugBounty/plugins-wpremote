...
if (!class_exists('WPRProtectFWRuleEngine_V602')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V602 {
	use WPRProtectFWRuleStringFunc_V602;
	use WPRProtectFWRuleArrayFunc_V602;
	use WPRProtectFWRuleMiscFunc_V602;
	use WPRProtectFWRuleRequestFunc_V602;
	use WPRProtectFWRuleWPFunc_V602;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V602::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V602 $e) {
			$this->error = $e;
		}
	}
