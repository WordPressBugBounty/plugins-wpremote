...
if (!class_exists('WPRProtectLP_V644')) :
class WPRProtectLP_V644 {
	private $ip;
	private $time;
	private $ipstore;
	private $logger;
	...
	private $mode              = WPRProtectLP_V644::MODE_DISABLED;
	...
	private $category          = WPRProtectLP_V644::CATEGORY_ALLOWED;
	private $username          = '';
	private $message           = '';
