...
if (!class_exists('WPRProtectWPUser_V639')) :
class WPRProtectWPUser_V639 {
	public $id;
	public $role;
	public $role_level;
	public $capabilities;
	...
	public static function defaultUser() {
		...
		return (new WPRProtectWPUser_V639(0, 0, array(), $time));
	}
	...
	public static function _unserialize($serialized_user) {
		...
		return (new WPRProtectWPUser_V639((int) $id, (int) $role_level, $capabilities, (int) $time));
	}
