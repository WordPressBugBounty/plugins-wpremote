...
if (!class_exists('WPRProtectWPUser_V669')) :
class WPRProtectWPUser_V669 {
	public $id;
	public $role;
	public $role_level;
	public $capabilities;
	...
	public static function defaultUser() {
		...
		return (new WPRProtectWPUser_V669(0, 0, array(), $time));
	}
	...
	public static function _unserialize($serialized_user) {
		...
		return (new WPRProtectWPUser_V669((int) $id, (int) $role_level, $capabilities, (int) $time));
	}
