...
if (!class_exists('WPRProtectWPUser_V602')) :
class WPRProtectWPUser_V602 {
	public $id;
	public $role;
	public $role_level;
	public $capabilities;
	...
	public static function defaultUser() {
		...
		return (new WPRProtectWPUser_V602(0, 0, array(), $time));
	}
	...
	public static function _unserialize($serialized_user) {
		...
		return (new WPRProtectWPUser_V602((int) $id, (int) $role_level, $capabilities, (int) $time));
	}
