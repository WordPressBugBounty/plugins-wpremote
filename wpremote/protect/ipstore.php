...
class WPRProtectIpstore_V662 {
	...
	function __construct($storage_type = WPRProtectIpstore_V662::STORAGE_TYPE_DB) {
		$this->storage_type = $storage_type;
		if ($this->storage_type == WPRProtectIpstore_V662::STORAGE_TYPE_FS) {
			$this->storage = new WPRProtectIpstoreFS_V662();
		} else {
			$this->storage = new WPRProtectIpstoreDB_V662();
		}
	}

	public static function uninstall() {
		WPRProtectIpstoreDB_V662::uninstall();
	}

	public function isLPIPBlacklisted($ip) {
		if ($this->storage_type == WPRProtectIpstore_V662::STORAGE_TYPE_DB) {
