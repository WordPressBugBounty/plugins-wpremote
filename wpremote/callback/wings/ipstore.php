...
class WPRIPStoreCallback extends WPRCallbackBase {
	...
	public function getIPs($table, $auto_increment_offset, $type, $category) {
		...
		$query .= ($category == WPRProtectIpstoreDB_V648::CATEGORY_FW) ? "`is_fw` = true;" : "`is_lp` = true;";
	...
	public function getIPStoreInfo($table, $auto_increment_offset) {
		...
		$info['fw_blacklisted_ips'] = $this->getIPs($table, $auto_increment_offset,
			WPRProtectIpstoreDB_V648::blacklistedTypes(), WPRProtectIpstoreDB_V648::CATEGORY_FW);
		$info['lp_blacklisted_ips'] = $this->getIPs($table, $auto_increment_offset,
			WPRProtectIpstoreDB_V648::blacklistedTypes(), WPRProtectIpstoreDB_V648::CATEGORY_LP);
		$info['fw_whitelisted_ips'] = $this->getIPs($table, $auto_increment_offset,
			WPRProtectIpstoreDB_V648::whitelistedTypes(), WPRProtectIpstoreDB_V648::CATEGORY_FW);
		$info['lp_whitelisted_ips'] = $this->getIPs($table, $auto_increment_offset,
			WPRProtectIpstoreDB_V648::whitelistedTypes(), WPRProtectIpstoreDB_V648::CATEGORY_LP);
